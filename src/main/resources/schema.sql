...
CREATE TABLE USERS (
ID INT AUTO_INCREMENT  PRIMARY KEY,
USER_NAME VARCHAR2(200) UNIQUE NOT NULL,
PASSWORD VARCHAR2(500) NOT NULL,
ROLE_NAME VARCHAR2(50) NOT NULL ,
CONSTRAINT FK_USER_ID FOREIGN KEY (USER_NAME) REFERENCES USER_INFO(USER_NAME),
...
CONSTRAINT FK_BOOKING_USER_ID FOREIGN KEY (USER_NAME) REFERENCES USER_INFO(USER_NAME),
